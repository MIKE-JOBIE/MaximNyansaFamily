                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownBlog">
                                <a class="dropdown-item" href="soft.html">Software Engineering</a>
                                <a class="dropdown-item" href="data.html">Data Science</a>
                                <a class="dropdown-item" href="agile.html"> Agile SCRUM Practices</a>
                            </div>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="set.html">Contact</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="touch-line">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <a class="btn btn-lg btn-secondary btn-block" href="set.html"> Contact Us </a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6 col">
                        ...
                        <ul class="footer-social">
                            ...
                            <li><a class="youtube hb-xs-margin" href="https://www.youtube.com/channel/UCTYJus0hr3iI9wvxqzHle"><span class="hb hb-xs spin hb-google-plus"><i class="fab fa-google-plus-g"></i></span></a></li>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        ...
                        <ul class="footer_ul_amrc">
                            ...
                            <li><a href="soft.html"><i class="fas fa-long-arrow-alt-right"></i>Software Engineering </a></li>
                            <li><a href="data.html"><i class="fas fa-long-arrow-alt-right"></i>Data Science</a></li>
